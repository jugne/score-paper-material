...
system('rm -r score_high_reas mascot_high_reas sim_compare_high_reas');
system('mkdir score_high_reas mascot_high_reas sim_compare_high_reas');
...
h = fopen('rates_compare_high_reas.csv', 'w');fprintf(h, 'run,Ne_1,Ne_2,reassortment_1,reassortment_2,migration_1, migration_2 \n');
...
%     migration_2 = exprnd(mean_mig);
    ...
    g = fopen(sprintf('sim_compare_high_reas/sim_%d.xml', i), 'w');
...
%         for r = 1 : 3
            ...
            g = fopen(sprintf('score_high_reas/inf_%s_%d.xml', evol_name{uncertainty}, i), 'w');
...
%                     fprintf(g, strrep(line, 'initial_reassortment', num2str(exprnd(1))+" "+num2str(exprnd(1))));
                ...
                elseif contains(line, 'insert_sim_file_name')
                    line = strrep(line, 'insert_sim_file_name', sprintf('../sim_compare_high_reas/sim_%d', i) );
...
%         for r = 1 : 3
            ...
            % open the inf_compare xml
%             if length(rate) > 1
%                 g = fopen(sprintf('mascot_high_reas/inf_%s_%s_%d.xml', evol_name{uncertainty}, rate{r}, i), 'w');
%             else
                g = fopen(sprintf('mascot_high_reas/inf_%s_%d.xml', evol_name{uncertainty}, i), 'w');
%             end
